    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="panel-group">
                <form method="post" action="{{ route('xe_popup::setting.add') }}" enctype="multipart/form-data" data-rule="rule1" data-rule-alert-type="toast" >
                    {{ csrf_field() }}
                    <div class="panel">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="popup_name" value="{{Request::old('popup_name')}}" data-valid-name="{{ xe_trans('xe_popup::popupName') }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="occur_type" data-selected-value="{{Request::old('occur_type')}}">
                                ...
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <div class="checkbox-group" data-checkbox-value="{{json_enc(Request::old('occur_module_info'))}}">
                                ...
                                <div class="col-md-6 form-col" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="occur_url_info" value="{{Request::old('occur_url_info')}}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="popup_open_type" data-selected-value="{{Request::old('popup_open_type')}}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="popup_content_type" data-selected-value="{{Request::old('popup_content_type')}}">
                                ...
                                <div class="col-md-6 form-col" >
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="popup_content_html">{{Request::old('popup_content_html')}}</textarea>
                                ...
                                <div class="col-md-6 form-col" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        'value' => Request::old('popup_content_file'),
                                        //'width' => 80,
                                        //'height' => 80,
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="link" value="{{Request::old('link')}}" data-valid-name="{{ xe_trans('xe_popup::link') }}">
                                ...
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="link_target" value="{{Request::old('link_target')}}">
                                ...
                                <div class="col-md-6 form-col">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" name="size_width" value="{{Request::old('size_width')}}">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input class="form-control" name="size_height" value="{{Request::old('size_height')}}">
                                            <div class="input-group-append">
                                                <span class="input-group-text">px</span>
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="position_x" value="{{Request::old('position_x')}}">
                                            <div class="input-group-append">
                                                <span class="input-group-text">px</span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control" name="position_y" value="{{Request::old('position_y')}}">
                                            <div class="input-group-append">
                                                <span class="input-group-text">px</span>
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="inactive_days" value="{{Request::old('inactive_days')}}">
                                ...
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="inactive_days_message" value="{{Request::old('inactive_days_message')}}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="status" data-selected-value="{{Request::old('status')}}">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-col">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="expose_type" data-selected-value="{{Request::old('expose_type')}}">
                                            <option value="0" >{!!xe_trans('xe::disuse')!!}</option>
                                ...
                                <div class="col-md-6 form-col" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="startDatePicker" name="started_at" class="form-control datetimepicker-input" value="{{Request::old('started_at')}}" data-end-with="endDatePicker" data-date-format="Y-m-d H:i:00" data-timepicker="1" data-default-time="00:00">
                                        </div>
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" id="endDatePicker" name="ended_at" class="form-control datetimepicker-input" value="{{Request::old('ended_at')}}" data-start-with="startDatePicker" data-date-format="Y-m-d H:i:00" data-timepicker="1" data-default-time="00:00">
                                        </div>
                                ...
                                <div class="col-md-6 form-col" style="display:none;">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="endTimePicker" name="started_time_at" class="form-control datetimepicker-input" value="{{Request::old('started_time_at')}}" data-end-with="endTimePicker" data-date-format="H:i:00" data-datepicker="0" data-default-time="00:00">
                                        </div>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="endTimePicker" name="ended_time_at" class="form-control datetimepicker-input" value="{{Request::old('ended_time_at')}}" data-start-with="startTimePicker" data-date-format="H:i:00" data-datepicker="0" data-default-time="23:00">
                                        </div>
